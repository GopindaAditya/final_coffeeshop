...
class OwnerController extends Controller
{
    ...
    function addProduk(Request $request)
    {
        $request->validate([
            ...
            // Aturan validasi tambahan untuk gambar?
        ]);
    ...
    public function cetakLaporan()
    {
        ...
        // Ambil data penjualan berdasarkan tahun dan bulan saat ini dan join dengan tabel Produks
        $data = Detail_penjualan::whereYear('Detail__penjualan.updated_at', $tahunSekarang)
            ->whereMonth('Detail__penjualan.updated_at', $bulanSekarang)
            ->join('Produks', 'Detail__penjualan.id_menu', '=', 'Produks.id')
            ->select('Detail__penjualan.id_transaksi', 'Detail__penjualan.id_menu', 'Produks.name', 'Detail__penjualan.size', 'Detail__penjualan.jumlah', 'Detail__penjualan.harga_penjualan', 'Detail__penjualan.updated_at as tanggal_transaksi')
            ->get();
